 ...
 const {favoriteMovies} = useAppContext()
  ...
  return (
    ...
    <div className='flex items-center gap-8'>
        ...
        {
            !user ? (
                <button onClick={() => openSignIn({ fallbackRedirectUrl: '/' })} className='px-4 py-1 sm:px-7 sm:py-2 bg-primary hover:bg-primary-dull transition rounded-full font-medium cursor-pointer'>Login</button>
            ) : (
                <UserButton>
